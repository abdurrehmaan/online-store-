...
//RTK
import { useAuthLogoutMutation } from "@/redux/features/auth-api";
...
export default function Navbar() {
  ...
  useEffect(() => {
    if (window !== undefined) {
      const itemsCount = window.localStorage.getItem("cart");
      setItemCount(itemsCount ? JSON.parse(itemsCount).length : 0);
    }
  });
            ...
            <div className="flex h-16 justify-between px-10">
                ...
                <div className="flex flex-shrink-0 items-center">
                  <Link href={"/"} className="flex items-center">
                    <Image
                      ...
                      width={30}
                    />
                    <h2 className="ml-4 text-2xl font-bold leading-9 tracking-tight text-gray-900">
                      Online Store
                    </h2>
                  </Link>
                </div>
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <Link href={"/dashboard/cart"} className="">
                  <div className=" bg-gray-100 flex justify-center items-center mr-8">
